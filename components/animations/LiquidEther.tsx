...
void main(){
  ...
  gl_FragColor = vec4(newv, 0.0, 0.0);
    ...
    class Viscous extends ShaderPass {
      ...
      updateViscous(params: { viscous: number; iterations: number; dt: number }) {
        let fbo_out: any;
    ...
    class Poisson extends ShaderPass {
      ...
      updatePoisson(params: { iterations: number }) {
        let p_out: any;
        for (let i = 0; i < params.iterations; i++) {
          let p_in;
          if (i % 2 === 0) {
    ...
    class Pressure extends ShaderPass {
      ...
      updatePressure(params: { vel: any; pressure: any }) {
        this.uniforms.velocity.value = params.vel.texture;
    ...
    class Simulation {
      ...
      update() {
        ...
        if (this.options.isViscous) {
          vel = this.viscousPass.updateViscous({
            viscous: this.options.viscous,
            iterations: this.options.iterations_viscous,
            dt: this.options.dt,
          });
        }
        this.divergence.updateDiv({ vel });
        const pressureResult = this.poisson.updatePoisson({
          iterations: this.options.iterations_poisson,
        });
        this.pressure.updatePressure({ vel, pressure: pressureResult });
      }
    }
